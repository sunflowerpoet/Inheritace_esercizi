package Esercizio01;/*Scrivere un programma che contenga una classe chiamata Animale ed un metodo chiamato faiIlVerso()
...
public class Main {
    public static void main(String[] args) {
        ...
        animale.faiIlVerso();
        System.out.println("Il verso del gatto e':");
        gatto.faiIlVerso();
    }
}